...
@section('title')
<title>Ecommerce |Ajout Article</title>
@endsection
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Ajout <small>nouvel article...</small></h3>
            </div>
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" action="{{url('/create_article')}}" method="post" enctype="multipart/form-data" >
              @csrf
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="nom_article" class="form-control" id="nom_article" oninput="reference();"  placeholder="Entrer un nom pour l'article">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="prix_ht_article" class="form-control" id="prix_ht_article" placeholder="Entrer le prix HT">
                </div>
                <div class="form-group">
                  <label for="description_article">Description de l'article</label>
                  <textarea name="description_article" class="form-control" id="description_article" placeholder="Entrer les détails concernant le produit...."></textarea>
                </div>
  ...
  $('#quickForm').validate({
    ...
    messages: {
      ...
      description_article: {
        ...
        minlength: "Entrez un minimun de 30 caractères",
