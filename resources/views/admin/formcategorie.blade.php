...
@section('title')
<title>Ecommerce |Ajout Catégorie</title>
@endsection
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Ajout <small>nouvelle catégorie </small></h3>
            </div>
 <!----------------------------- Messages de succès---->
...
<!--------------- Fin  Validation des champs obligatoires---->
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" action="{{url('/create_categorie')}}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
             ...
             {{--  {!!Form::open(['action'=>'App\Http\Controllers\AdminController@creerCategorie', 'method'=>'POST', 'enctype' => 'multipart/form-data', 'role'=>'form', 'id'=>'quickForm']) !!}} --}}
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" name="nom_categorie" class="form-control" id="nom_categorie" placeholder="Entrer un nom pour la nouvelle catégorie">
