      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form id="quickForm"  action="{{url('/create_slider')}}" method="post" enctype="multipart/form-data" >
              @csrf
              
              <div class="card-body">
                <div class="form-group">
                  <label for="description1_slider">Description 1 slider</label>
                  <input type="text" name="description1_slider" class="form-control" id="description1_slider" placeholder="Description slider....">
                </div>
                <div class="form-group">
                  <label for="description2_slider">Description 2 slider</label>
                  <input type="text" name="description2_slider" class="form-control" id="description2_slider"   placeholder="Description slider....">
                </div> 
