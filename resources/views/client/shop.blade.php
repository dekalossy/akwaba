      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="{{route('accueil')}}">Accueil</a></span> <span>Articles</span></p>
            <h1 class="mb-0 bread">Articles</h1>
          </div>
        </div>
      </div>
    </div>
    	...
    	<div class="container">
    		<div class="row justify-content-center">
    			<div class="col-md-10 mb-5 text-center">
    				<ul class="product-category">
						...
						<li><a href="{{url('shop/'.$categorie->NOM_CATEGORIE)}}" 
							class="{{request()->is('shop/'.$categorie->NOM_CATEGORIE) ? 'active' : ''}}">{{$categorie->NOM_CATEGORIE}}</a></li>
						@endforeach
    		...
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="{{asset('storage/images_articles/'.$article->IMAGE)}}" alt="{{$article->NOM_ARTICLE}}">
