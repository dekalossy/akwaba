    ...
    <section id="home-section" class="hero">
		  <div class="home-slider owl-carousel">
			...
			@foreach ($sliders as $slider )		
				...
				<div class="slider-item" style="background-image: url({{asset('storage/images_sliders/'.$slider->IMAGE_SLIDER)}});">
					<div class="overlay"></div>
					<div class="container">
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

						<div class="col-sm-12 ftco-animate text-center">
						<h1 class="mb-2" style=" font-family: Poppins;">{{$slider->DESCRIPTION_1}}</h1>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                ...
                <span>Achat supérieur à $50</span>
              </div>
            </div>      
          </div>
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Meilleur Qualité</h3>
          ...
          <div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services mb-md-0 mb-4">
              ...
              <div class="media-body">
                <h3 class="heading">Disponibilité</h3>
                <span>24/7 à votre écoute</span>
              </div>
            </div>      
          </div>
        </div>
				...
				<div class="row">
							...
							<div class="col-md-6">
								<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(frontend/images/category-1.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Tresses</a></h2>
									</div>
								</div>
								<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(frontend/images/category-2.jpg);">
									<div class="text px-3 py-1">
										<h2 class="mb-0"><a href="#">Nappies</a></h2>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-md-4">
						<div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url(frontend/images/category-3.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Nattes</a></h2>
							</div>		
						</div>
						<div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url(frontend/images/category-4.jpg);">
							<div class="text px-3 py-1">
								<h2 class="mb-0"><a href="#">Tissages</a></h2>
							</div>
						</div>
					</div>
				</div>
    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="{{asset('storage/images_articles/'.$article->IMAGE)}}" alt="Colorlib Template">
    						<span class="status">30%</span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">{{$article->NOM_ARTICLE}}</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">$120.00</span><span class="price-sale">{{$article->PRIX_HT_ARTICLE}}</span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="{{url('ajouter_au_panier/'.$article->ID_ARTICLE)}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
